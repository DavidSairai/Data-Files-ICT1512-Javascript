...
// function to place daysOfWeek values in header row cells 20 
function addColumnHeaders() { var i = 0;
}

while (i < 7) 
{ 
    document.getElementsByTagName("th")[i].innerHTML = daysOfWeek[i]; i++; } 
    } 
// function to place day of month value in first p element 29 
// within each table data cell that has an id 30 function addCalendarDates() { 31 var i = 1;
    var paragraphs = "";
    do {
    ...
    // function to place opponents and gameLocation values in 41 
    ...
    function addGameInfo() {
        ...
        for (var i = 0; i < 31; i++) {
            ...
            paragraphs = tableCell.getElementsByTagName("p");
             /* if (gameLocation[i] === "away") { 49 paragraphs[1].innerHTML = "@ ";
              } 
